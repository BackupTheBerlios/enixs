...
SOURCES  += friendlist/friendlist.cpp transfer/import.cpp
SOURCES  += widgets/commline.cpp widgets/addressbox.cpp widgets/jobbox.cpp
SOURCES  += widgets/photo.cpp
...
HEADERS  += friendlist/friendlist.h transfer/import.h
HEADERS  += widgets/commline.h widgets/addressbox.h widgets/jobbox.h
HEADERS  += widgets/photo.h
